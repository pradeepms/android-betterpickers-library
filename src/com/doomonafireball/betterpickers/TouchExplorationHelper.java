...
/* Removed for backwards compatibility to GB implements View.OnHoverListener */{
	 ...
	 */
	@SuppressLint("NewApi") public boolean sendEventForItem(T item, int eventType) {
	 ...
	 * 
	 * @Override public boolean onHover(View view, MotionEvent event) { if
	 * (!AccessibilityManagerCompat.isTouchExplorationEnabled(mManager)) {
	 * return false; }
	 * 
	 * switch (event.getAction()) { case MotionEvent.ACTION_HOVER_ENTER: case
	 * MotionEvent.ACTION_HOVER_MOVE: final T item = getItemAt(event.getX(),
	 * event.getY()); setCurrentItem(item); return true; case
	 * MotionEvent.ACTION_HOVER_EXIT: setCurrentItem(null); return true; }
	 * 
	 * return false; }
	 */
	...
	private AccessibilityNodeInfoCompat populateNodeForItemInternal(T item,
	 ...
	 *         the screen.
	 */
	@SuppressLint("NewApi") private boolean intersectVisibleToUser(Rect localRect) {
	...
	private final AccessibilityDelegateCompat mDelegate = new AccessibilityDelegateCompat() {
		@Override public void onInitializeAccessibilityEvent(View view, AccessibilityEvent event) {
			super.onInitializeAccessibilityEvent(view, event);
			event.setClassName(view.getClass().getName());
		}

		@Override public void onInitializeAccessibilityNodeInfo(View view,
				AccessibilityNodeInfoCompat info) {
			super.onInitializeAccessibilityNodeInfo(view, info);
			info.setClassName(view.getClass().getName());
		}

		@Override public AccessibilityNodeProviderCompat getAccessibilityNodeProvider(View host) {
	 ...
	 * the following:
	 * <ul>
	 * <li>appending text to
	 * {@link android.view.accessibility.AccessibilityEvent#getText()}</li>
	 * <li>populating a description with
	 * {@link android.view.accessibility.AccessibilityEvent#setContentDescription(CharSequence)}
	 * </li>
	 * </ul>
	 * </p>
	 * 
	 ...
	 * {@link AccessibilityNodeInfoCompat#setContentDescription(CharSequence)}</li>
